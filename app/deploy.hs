...
main :: IO ()
main = do
  [ nombrePool, mastersStr, uTxOutRefStr, begintAtPoolStr, deadlinePoolStr, graceTimeStr, staking_UI, staking_CS_Str, staking_TN_Str, harvest_UI, harvest_CS_Str, harvest_TN_Str, interestStr, pathOutputFiles ] <- getArgs
